...
namespace EnhancedBlogger.Controllers
{
    public class BlogPostsController : Controller
    {
        ...
        public BlogPostsController(EnhancedBloggerContext context)
        {
            _context = context;
        }
        ...
        {
            var enhancedBloggerContext = _context.BlogPost.Include(b => b.BlogInfo);
        ...
        {
            ViewData["BlogInfoId"] = new SelectList(_context.BlogInfo, "BlogInfoId", "BlogInfoId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("BlogPostId,BlogInfoId,BlogPostTitle,BlogText,PostCreateDate")] BlogPost blogPost)
        {
